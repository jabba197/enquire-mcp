...
[![tests](https://img.shields.io/badge/tests-1340%20passing-brightgreen.svg)](#trust)
...
| **46 production tools** (35 always-on read tools + 4 opt-in + 7 gated writes) | ✅ | n/a | varies |
...
| **Index maintenance** | `obsidian_reindex` (needs `--persistent-index`) |
